...
Map = (function() {
  ...
  Map.prototype.createSiteMarker = function(site, handleSiteSelection) {
    ...
    return google.maps.event.addListener(marker, 'click', handleSiteSelection);
  };

  Map.prototype.highlightSiteMarker = function(siteCode, bounceTimeout) {
    var marker;
    if (bounceTimeout == null) {
      bounceTimeout = 2500;
    }
    this.clearSelection();
    this.showSiteInfoWindow(siteCode);
  ...
  Map.prototype.clearSelection = function() {
    ...
    if (this.openInfoWindow) {
      return this.openInfoWindow.close();
    }
  };
